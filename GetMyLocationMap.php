<div id="GeoAPI"></div>
    ...
    function doStuff(mylat, mylong) {
      if (document.getElementById("GeoAPI")) {
        document.getElementById("GeoAPI").innerHTML = "<iframe style=\"width: 100%; height: 100%\" frameborder=\"0\" scrolling=\"no\" marginheight=\"0\" marginwidth=\"0\" src=\"//maps.google.com/?ll=" + mylat + "," + mylong + "&z=16&output=embed\"></iframe>";
      }
    }
    </script>