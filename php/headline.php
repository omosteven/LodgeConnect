...
<div class = "nav-bar" id = "navBar">
    <div class = "menu-down" id = "menuDown">
        <a href = "javascript:void(0);" onclick = "displayPrivate()"><i class="fa fa-bars"></i> My Activities</a>
        <div class="dropdownContent w3-animate-left" id="dropdownContent">
            <a href='cart.php'>My Cart</a>
            <a href="javascript:void(0);">My Order</a>
            <a href='chats.php'>Chats</a>
            <a href="javascript:void(0);">Contacts</a>
            <a href='savecarddetails.php'>Payment</a>
        </div>
    </div>
    
    <div class="other-contents" id = "otherContents" >
        <a href = "javascript:void(0);" class="others-stimulator" onclick = "displayOthers()"><i class="fa fa-bars"></i> Other activities</a>
